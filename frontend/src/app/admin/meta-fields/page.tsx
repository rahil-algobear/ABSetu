...
import { metaFieldSchemaApi } from "@/services/api";
import {
  EntityType,
  MetaFieldDefinition,
  MetaFieldSchemas,
...
const ENTITY_TYPES: { value: EntityType; label: string }[] = [
  ...
  { value: "session_template", label: "Session Templates" },
...
export default function MetaFieldsPage() {
  ...
  const [selectedEntity, setSelectedEntity] = useState<EntityType>("beneficiary");
  const [modalOpen, setModalOpen] = useState(false);
  const [editingIndex, setEditingIndex] = useState<number | null>(null);
  const [fieldForm, setFieldForm] = useState<MetaFieldDefinition>({
    ...emptyField,
  });
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFieldForm({
                  ...fieldForm,
                  type: e.target.value as MetaFieldType,
                })
              }
            >
              {FIELD_TYPES.map((ft) => (
